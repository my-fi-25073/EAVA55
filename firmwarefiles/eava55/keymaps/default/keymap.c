...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        EXTRA2,  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    LO_COMM, RA_DOT,  KC_RSFT,          POINT,   MS_BTN3, MS_BTN2, 
        EXTRA1,  LOWER,   KC_LALT,                   KC_SPC,  KC_SPC,           KC_SPC,           MC_LCTL, RAISE,            MS_BTN1, DRG_SCR, EXTRA2
    ),
    [1] = LAYOUT(
        KC_ESC,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, 
        KC_TAB,  XXXXXXX, KC_7,    KC_8,    KC_9,    KC_0,    KC_GRV,  KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC,          KC_BSLS, 
        MC_LCMD, XXXXXXX, KC_4,    KC_5,    KC_6,    XXXXXXX, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX,          KC_QUOT, 
        _______, KC_LSFT, XXXXXXX, KC_1,    KC_2,    KC_3,    XXXXXXX, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_RSFT,          _______, _______, _______, 
        _______, _______, KC_LALT,                   _______, _______,          _______,          MC_LCTL, _______,          _______, _______, _______
    ),
    [2] = LAYOUT(
        KC_ESC,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, 
        ...
        _______, KC_LSFT, XXXXXXX, KC_F1,   KC_F2,   KC_F3,   KC_F12,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_RSFT,          _______, _______, _______, 
        _______, _______, KC_LALT,                   _______, _______,          _______,          MC_LCTL, _______,          _______, _______, _______
    ),
    [3] = LAYOUT(
        ...
        _______, KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, VS_BRCK, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_RSFT,          _______, _______, _______, 
        _______, _______, KC_LALT,                   _______, _______,          _______,          MC_LCTL, _______,          _______, _______, _______
    ),
    [4] = LAYOUT(
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, 
        KC_ESC,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_GRV,  KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC,          KC_BSLS, 
        MC_LCMD, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_SCLN,          KC_QUOT, 
        _______, KC_LSFT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_COMM, KC_DOT,  KC_SLSH,          _______, _______, _______, 
        _______, _______, KC_LALT,                   _______, _______,          _______,          MC_LCTL, _______,          _______, _______, _______
    ),
    [5] = LAYOUT(
        XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, 
        XXXXXXX, XXXXXXX, SH____7, SH____8, SH____9, SH____0, SH__GRV, SH_MINS, SH__EQL, SH_LBRC, SH_RBRC,          SH_BSLS, 
        MC_LCMD, XXXXXXX, SH____4, SH____5, SH____6, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, SH_SCLN,          SH_QUOT, 
        _______, KC_LSFT, XXXXXXX, SH____1, SH____2, SH____3, XXXXXXX, XXXXXXX, XXXXXXX, SH_COMM, SH_DOT,  SH_SLSH,          _______, _______, _______, 
        _______, _______, KC_LALT,                   _______, _______,          _______,          MC_LCTL, _______,          _______, _______, _______
    )
};
